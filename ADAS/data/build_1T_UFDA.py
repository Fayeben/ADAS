...
from xmuda.data.collate_1T import get_collate_scn
from xmuda.common.utils.sampler import IterationBasedBatchSampler
from xmuda.data.nuscenes.nuscenes_dataloader_1T_UFDA import NuScenesSCN_1T_UFDA
from xmuda.data.nuscenes.nuscenes_dataloader_1T_UFDA import NuScenesSCN_1T
...
def build_dataloader_UFDA(cfg, mode='train', domain='source', start_iteration=0, halve_batch_size=False):
    ...
    if dataset_cfg.TYPE == 'NuScenesSCN':
        if mode == 'train':
            dataset = NuScenesSCN_1T_UFDA(split=split,
